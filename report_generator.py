...
def generate_report(results):
    ...
    weekly_chart_fig, annual_chart_fig = create_time_savings_charts(teacher_time_saved_weekly, counselor_time_saved_weekly)
    ...
    <body>
        ...
        <div class="chart-container">{annual_chart_html}
    ...
    <div class="chart-container" id="weekly-time-chart">
        {time_fig_weekly.to_html(full_html=False, include_plotlyjs=False)}
    </div>
    <div class="chart-container" id="annual-time-chart">
        {time_fig_annual.to_html(full_html=False, include_plotlyjs=False)}
    </div>
